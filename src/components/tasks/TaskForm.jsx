    ...
    return (
        <div className='max-w-md mx-auto'>
            <form className='bg-neutral-700 p-10 mb-4' action="" onSubmit={handleSubmit}>
                ...
                <input className='bg-slate-300 p-3 w-full mb-2 placeholder-gray-500' placeholder='escribe tu Tarea' value={title} onChange={(e) => setTitle(e.target.value)} />
                <textarea className='bg-slate-300 p-3 w-full mb-2 placeholder-gray-500' placeholder='Escribe la descripcion de la Tarea' value={desc} onChange={(e) => setDesc(e.target.value)}></textarea>
